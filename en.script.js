...
const products = [
    ...
    },
    {
        ...
        data: [
            ...
            ['param', ['with a cod length of 5 -10 mm', 6.5, 10]],
            ['param', ['for 2 - 3 mm drowning movement', 2.5, '6 - 8']],
            ['param', ['Drum wrap frequency, hv-1', '750 - 1500', '500 - 1000']],
            ['header', ['Drum size, mm:']],
            ['param', ['length', 400, 600]],
    ...
    },
    {
        ...
        data: [
            ...
            ['param', ['with a cod length of 5 - 10 mm', 17]],
    ...
    },
    {
        ...
        data: [
            ...
            ['param', ['Dimensions of briquettes, section, mm', '50 X 50']],
            ['param', ['Length, mm', 300]],
